...
- Archives `2013-archive/2025-archive` are read-only — never modify their contents. (`.2024` was removed 2026-07-06 at Luke's request — it duplicated 2013's landing page.)
...
*Accept:* local serve renders identically to production; archive paths `/2013-archive/ /2025-archive/` load; Playwright test proves the root + archives render + archive links resolve.
